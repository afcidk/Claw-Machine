...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Claw-Machine.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=modules/IR.c modules/TT.c modules/TM1637.c modules/XYSendor.c modules/motor.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/modules/IR.p1 ${OBJECTDIR}/modules/TT.p1 ${OBJECTDIR}/modules/TM1637.p1 ${OBJECTDIR}/modules/XYSendor.p1 ${OBJECTDIR}/modules/motor.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/modules/IR.p1.d ${OBJECTDIR}/modules/TT.p1.d ${OBJECTDIR}/modules/TM1637.p1.d ${OBJECTDIR}/modules/XYSendor.p1.d ${OBJECTDIR}/modules/motor.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/modules/IR.p1 ${OBJECTDIR}/modules/TT.p1 ${OBJECTDIR}/modules/TM1637.p1 ${OBJECTDIR}/modules/XYSendor.p1 ${OBJECTDIR}/modules/motor.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=modules/IR.c modules/TT.c modules/TM1637.c modules/XYSendor.c modules/motor.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Claw-Machine.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=18F4520
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/modules/IR.p1: modules/IR.c  nbproject/Makefile-${CND_CONF}.mk
...
dist/${CND_CONF}/${IMAGE_TYPE}/Claw-Machine.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Claw-Machine.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Claw-Machine.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
